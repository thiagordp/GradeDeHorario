...
CODIGO_PROFESSOR1 INT,
CODIGO_PROFESSOR2 INT,
CODIGO_PROFESSOR3 INT,
...
HORARIO_GRADE INT,
PRIMARY KEY(HORARIO_GRADE, DIA_SEMANA_GRADE)
)
...
DIA_SEMANA_GRADE INT,
HORARIO_GRADE INT,
PRIMARY KEY(SEQ_TURMA,SEQ_DISCIPLINA_CURSO,HORARIO_GRADE,DIA_SEMANA_GRADE),
FOREIGN KEY(SEQ_TURMA, SEQ_DISCIPLINA_CURSO) REFERENCES DISCIPLINA_TURMA (SEQ_TURMA, SEQ_DISCIPLINA_CURSO),
FOREIGN KEY(HORARIO_GRADE, DIA_SEMANA_GRADE) REFERENCES GRADE (HORARIO_GRADE, DIA_SEMANA_GRADE)
)
