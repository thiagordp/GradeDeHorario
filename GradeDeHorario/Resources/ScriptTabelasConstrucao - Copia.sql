...
CODIGO_DISCIPLINA VARCHAR(7),
CODIGO_TURMA VARCHAR(6),
PRIMARY KEY(DIA_SEMANA_GRADE,HORARIO_GRADE,SEQ_SEMESTRE,CODIGO_CURSO,CODIGO_DISCIPLINA,CODIGO_TURMA)
)
...
PRIMARY KEY(SEQ_SEMESTRE,CODIGO_CURSO,CODIGO_DISCIPLINA,CODIGO_TURMA),
...
CODIGO_DISCIPLINA VARCHAR(7),
CODIGO_TURMA VARCHAR(6),
PRIMARY KEY(CODIGO_ESPACO,SEQ_SEMESTRE,CODIGO_CURSO,CODIGO_DISCIPLINA,CODIGO_TURMA),
FOREIGN KEY(CODIGO_ESPACO) REFERENCES ESPACO (CODIGO_ESPACO),
FOREIGN KEY(SEQ_SEMESTRE,CODIGO_CURSO,CODIGO_DISCIPLINA,CODIGO_TURMA) REFERENCES DISCIPLINA_TURMA (SEQ_SEMESTRE,CODIGO_CURSO,CODIGO_DISCIPLINA,CODIGO_TURMA)
)
...
ALTER TABLE GRADE_TURMA ADD FOREIGN KEY(SEQ_SEMESTRE,CODIGO_CURSO,CODIGO_DISCIPLINA,CODIGO_TURMA) REFERENCES DISCIPLINA_TURMA (SEQ_SEMESTRE,CODIGO_CURSO,CODIGO_DISCIPLINA,CODIGO_TURMA)