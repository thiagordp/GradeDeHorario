...
CREATE TABLE ESPACO (
SEQ_ESPACO INTEGER PRIMARY KEY,
...
SEQ_TURMA INTEGER,
SEQ_DISCIPLINA_CURSO INTEGER,
PRIMARY KEY(SEQ_ESPACO,SEQ_TURMA,SEQ_DISCIPLINA_CURSO),
...
ALTER TABLE ESPACO_TURMA ADD FOREIGN KEY(SEQ_ESPACO) REFERENCES ESPACO (SEQ_ESPACO)
