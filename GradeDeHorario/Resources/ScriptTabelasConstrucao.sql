...
CREATE TABLE TURMA (
SEQ_TURMA INTEGER PRIMARY KEY IDENTITY(1,1),
...
SEQ_SEMESTRE INTEGER PRIMARY KEY IDENTITY(1,1),
NOME_SEMESTRE VARCHAR(10)
)

CREATE TABLE DISCIPLINA_CURSO (
SEQ_DISCIPLINA_CURSO INTEGER PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE GRADE (
SEQ_GRADE INTEGER PRIMARY KEY IDENTITY(1,1),
