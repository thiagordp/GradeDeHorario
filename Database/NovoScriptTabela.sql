...
CODIGO_DISCIPLINA VARCHAR(7),
CODIGO_TURMA VARCHAR(6),
PRIMARY KEY(DIA_SEMANA_GRADE,HORARIO_GRADE,CODIGO_SEMESTRE,CODIGO_CURSO,CODIGO_DISCIPLINA,CODIGO_TURMA)
)
...
PRIMARY KEY(CODIGO_SEMESTRE,CODIGO_CURSO,CODIGO_DISCIPLINA,CODIGO_TURMA),
...
CODIGO_DISCIPLINA VARCHAR(7),
CODIGO_TURMA VARCHAR(6),
PRIMARY KEY(CODIGO_ESPACO,CODIGO_SEMESTRE,CODIGO_CURSO,CODIGO_DISCIPLINA,CODIGO_TURMA),
FOREIGN KEY(CODIGO_ESPACO) REFERENCES ESPACO (CODIGO_ESPACO),
FOREIGN KEY(CODIGO_SEMESTRE,CODIGO_CURSO,CODIGO_DISCIPLINA,CODIGO_TURMA) REFERENCES DISCIPLINA_TURMA (CODIGO_SEMESTRE,CODIGO_CURSO,CODIGO_DISCIPLINA,CODIGO_TURMA)
)
...
ALTER TABLE GRADE_TURMA ADD FOREIGN KEY(CODIGO_SEMESTRE,CODIGO_CURSO,CODIGO_DISCIPLINA,CODIGO_TURMA) REFERENCES DISCIPLINA_TURMA (CODIGO_SEMESTRE,CODIGO_CURSO,CODIGO_DISCIPLINA,CODIGO_TURMA)
